...
![image-20200405162151872](./images/202105112105.png)
...
ZGC收集器是一款基于Region内存布局的（暂时），不设分代的，使用了读屏障、染色指针和内存多重映射等技术来实现可并发标记-整理算法的，以低延迟为首要目标的一款垃圾收集器
